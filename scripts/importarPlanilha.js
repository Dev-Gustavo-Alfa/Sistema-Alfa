...
const excelDateToMysqlDate = (excelDate) => {
  if (typeof excelDate === "number" && !isNaN(excelDate)) {
    ...
    return new Date(startDate.getTime() + excelDate * 86400000)
      .toISOString()
      .split("T")[0];
  }
  return null;
...
const processarLigacaoFrutifera = (valor) => {
  if (valor === true || valor === "SIM" || valor === 1 || valor === "Sim")
    return "SIM";
  return "NÃO";
};
...
const importarDados = (filePath, tableName, columnsMap) => {
  ...
  data.forEach((row) => {
    ...
    const query = `INSERT INTO ${tableName} (${columnsMap
      .map((c) => c.db)
...
const fileCaptacaoGeral =
  "C:/Users/guhaq/OneDrive/Desktop/Projects/prototipo/captacao_geral.xlsx";
const fileIndicacao =
  "C:/Users/guhaq/OneDrive/Desktop/Projects/prototipo/indicacao.xlsx";
